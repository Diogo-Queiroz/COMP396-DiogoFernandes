...
public class EnemyEyes : Perception
{
    ...
    [SerializeField] private LayerMask _occlusionLayers; // Any layer that will block enemy from seeing the trackable
    ...
    private void Scan()
    {
        _count = Physics.OverlapSphereNonAlloc(transform.position, _distance, 
            _colliders, _trackableLayers, QueryTriggerInteraction.Collide);
    ...
    private bool IsInSight(GameObject go)
    {
        ...
        // Checked the Height position of the trackable
